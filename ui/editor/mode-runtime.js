...
var runtimeHighlightRules = function() {
    ...
    this.$rules = { start: 
      [ { token: 'keyword.control.runtime',
           regex: '\\b(?:let|jmp|slp|tim|add|sub|mul|mod|div|psh|pop|pol|put|get|key|del|int|str|typ|prs|drw|drt|pxl|clr|prt|inp|rnd|j(?:eq|ne|lt|gt)|ife|ifg|els|fin|def|ret|end|cal)\\b',
